...
Este site reúne a documentação técnica do **Prontuário Eletrônico e-SUS APS**, organizada em duas frentes principais:
...
- **[Catálogo de Dados](/catalogo-dados/)** — mapeamento técnico dos formulários das linhas de cuidado de **[Pré-Natal](/catalogo-dados/prenatal/)**, **[Câncer de Colo do Útero](/catalogo-dados/cancer-colo-utero/)** e **[Vacinação](/catalogo-dados/vacinacao/)**, relacionando os campos exibidos na interface do sistema às respectivas tabelas e colunas do banco de dados.
